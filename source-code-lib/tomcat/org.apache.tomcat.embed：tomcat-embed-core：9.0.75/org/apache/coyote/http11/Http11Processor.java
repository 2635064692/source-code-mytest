    ...
    public SocketState service(SocketWrapperBase<?> socketWrapper) throws IOException {
        ...
        while (!getErrorState().isError() && keepAlive && !isAsync() && upgradeToken == null &&
            ...
            try {
                ...
                // parse headers.
                prepareRequestProtocol();       //http版本标记

                if (protocol.isPaused()) {      //协议未使用
            ...
            // Has an upgrade been requested?  请求是否升级
            ...
            if (getErrorState().isIoAllowed()) {
                try {
                    ...
                    getAdapter().service(request, response);        //adapter 执行，将request做转换---》调用sevlet
