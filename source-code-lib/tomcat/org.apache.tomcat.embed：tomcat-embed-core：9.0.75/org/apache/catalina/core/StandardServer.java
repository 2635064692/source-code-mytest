 ...
 */
public final class StandardServer extends LifecycleMBeanBase implements Server {        //hLog 主server 包含service
     ...
     */
    private Service[] services = new Service[0];        //hLog server包含多个service
