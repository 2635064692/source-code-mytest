 ...
 */
public interface Servlet {      //servlet，需要注册到tomcat（即servlet容器）中
     ...
     */
    void service(ServletRequest req, ServletResponse res) throws ServletException, IOException;//客户端与服务端通信方法
