 ...
 * @author Joram Barrez
 */
public class TriggerExecutionOperation extends AbstractOperation {      //hLog 当前节点的触发执行操作，当前仅在任务完成后触发
        ...
        if (currentFlowElement instanceof FlowNode) {
            ...
            if (activityBehavior instanceof TriggerableActivityBehavior) {
                ...
                if (currentFlowElement instanceof BoundaryEvent) {
                    commandContext.getHistoryManager().recordActivityStart(execution);  //hLog 事件监听执行
                }
