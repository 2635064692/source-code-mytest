...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand consumerSendMsgBack(final ChannelHandlerContext ctx, final RemotingCommand request)
        ...
        String newTopic = MixAll.getRetryTopic(requestHeader.getGroup());   //hLog 重试topic
    ...
    private RemotingCommand sendMessage(final ChannelHandlerContext ctx,
        ...
        response.setCode(-1);
        super.msgCheck(ctx, requestHeader, response);       //hLog 消息校验，topic校验
        ...
        if (traFlag != null && Boolean.parseBoolean(traFlag)) {     //hLog 事务消息校验
            ...
            putMessageResult = this.brokerController.getTransactionalMessageService().prepareMessage(msgInner);     //hLog 事务半消息
        } else {
