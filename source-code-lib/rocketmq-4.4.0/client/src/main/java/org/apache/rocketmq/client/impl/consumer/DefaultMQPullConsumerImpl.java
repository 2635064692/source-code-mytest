            ...
            case CREATE_JUST:
                ...
                if (this.defaultMQPullConsumer.getOffsetStore() != null) {
                    ...
                    switch (this.defaultMQPullConsumer.getMessageModel()) {
                        case BROADCASTING:
                            this.offsetStore = new LocalFileOffsetStore(this.mQClientFactory, this.defaultMQPullConsumer.getConsumerGroup());       //hLog 广播消费，客户端本地存储消费进度
                            break;
                        case CLUSTERING:
                            this.offsetStore = new RemoteBrokerOffsetStore(this.mQClientFactory, this.defaultMQPullConsumer.getConsumerGroup());    //hLog 集群消费，broker存储消费进度
                            break;
                        default:
                            break;
                    }
