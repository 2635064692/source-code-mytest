...
public abstract class NettyRemotingAbstract {
     ...
     */
    protected final Semaphore semaphoreAsync;       //hLog 异步请求限流器
    ...
    public void invokeOnewayImpl(final Channel channel, final RemotingCommand request, final long timeoutMillis)
        ...
        boolean acquired = this.semaphoreOneway.tryAcquire(timeoutMillis, TimeUnit.MILLISECONDS);       //hLog oneway请求限流
        if (acquired) {
