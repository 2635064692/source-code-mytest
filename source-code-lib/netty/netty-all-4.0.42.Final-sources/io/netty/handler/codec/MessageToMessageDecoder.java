 ...
 *
 */
public abstract class MessageToMessageDecoder<I> extends ChannelInboundHandlerAdapter {     //hLog inbound 输入，读取，Decoder解码
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            if (acceptInboundMessage(msg)) {    //hLog 反射判断类型
