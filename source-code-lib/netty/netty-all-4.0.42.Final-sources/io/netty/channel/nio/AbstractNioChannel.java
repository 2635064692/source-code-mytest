...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    protected abstract class AbstractNioUnsafe extends AbstractUnsafe implements NioUnsafe {
        ...
        private void fulfillConnectPromise(ChannelPromise promise, boolean wasActive) {
            ...
            boolean active = isActive();    //hLog 上一步的判断active为false，经过finishConnect后为true
            ...
            if (!wasActive && active) {
                pipeline().fireChannelActive(); //hLog 发送active事件
            }
        ...
        public final void finishConnect() {
            ...
            try {
                boolean wasActive = isActive();
                doFinishConnect();      //hLog 完成连接，并检查连接是否成功
    ...
    protected void doRegister() throws Exception {
        ...
        for (;;) {
            try {
                selectionKey = javaChannel().register(eventLoop().selector, 0, this);     //hLog channel绑定selector，
                return;     //hLog ops暂为0，当前channel 未active
