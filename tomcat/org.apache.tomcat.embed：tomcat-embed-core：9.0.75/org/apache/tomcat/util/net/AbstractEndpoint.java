...
public abstract class AbstractEndpoint<S,U> {
    ...
    public void createExecutor() {
        ...
        executor = new ThreadPoolExecutor(getMinSpareThreads(), getMaxThreads(), 60, TimeUnit.SECONDS,taskqueue, tf);       //Tomcat线程池创建
    ...
    public boolean processSocket(SocketWrapperBase<S> socketWrapper,
            SocketEvent event, boolean dispatch) {          //http请求接受后放入tomcat线程池
        try {
